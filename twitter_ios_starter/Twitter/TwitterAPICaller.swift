...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "g7ulshpJ0Ruz9nfRuSVmeo85d", consumerSecret: "AulfNKtDWR74OhQ8pGUoYMRDop0OoUEdGBiLgv5x3MscEkcrl3")
    var loginSuccess: (() -> ())?
